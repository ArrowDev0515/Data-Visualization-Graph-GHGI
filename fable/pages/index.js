  ...
  return (
    <>
      ...
      <div className="my-2 mx-8 bg-[#113458] bg-opacity-10 rounded-xl items-center justify-center">
        <section id="emission_reduction_potential"><EmissionRedcutionPotentialComponent /></section>
        <section id="impacts_synergies"><ImpactsAndSynergiesComponent /></section>
      </div>
      <section id="data_explorer"><DataExplorerComponent /></section>
    </>
  )
}
